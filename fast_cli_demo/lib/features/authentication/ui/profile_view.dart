...
class _ProfileViewState extends State<ProfileView> {
  ...
  void initState() {
    firstNameController =
        TextEditingController(text: userService.user.value?.firstName);
    lastNameController =
        TextEditingController(text: userService.user.value?.lastName);
    emailController =
        TextEditingController(text: userService.user.value?.email);
    phoneController =
        TextEditingController(text: userService.user.value?.phone);
    super.initState();
  }
